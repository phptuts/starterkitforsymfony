...
namespace Tests\AdminBundle\Controller\Admin;
...
class UserControllerTest extends WebTestCase
{
    ...
    public function testChangeEmail()
    {
        ...
        Assert::assertNotNull($this->userRepository->findUserByEmail('change_email_user_1@gmail.com'));
    }
    ...
    {
        $user = $this->userRepository->findUserByEmail('future_admin_user@gmail.com');
